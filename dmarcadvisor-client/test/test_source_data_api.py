...
import dmarcadvisor
from dmarcadvisor.api.source_data_api import SourceDataApi  # noqa: E501
...
class TestSourceDataApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = dmarcadvisor.api.source_data_api.SourceDataApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_source_domains_list(self):
        """Test case for source_domains_list
