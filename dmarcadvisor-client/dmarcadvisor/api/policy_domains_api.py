...
class PolicyDomainsApi(object):
    ...
    def policy_domains_list(self, **kwargs):  # noqa: E501
        """List policy domains  # noqa: E501

        Lists policy domains the current user has access to.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.policy_domains_list(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int page: A page number within the paginated result set.
        :param int limit: Number of results to return per page.
        :param float filter_id: Policy filter id to filter domains by.
        :param str policy_ready: Show domains ready for new policy (True) or not (False).
        :param str recommendation: Filter results by recommendation.
        :return: ResponsesPolicyDomainList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.policy_domains_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.policy_domains_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def policy_domains_list_with_http_info(self, **kwargs):  # noqa: E501
        """List policy domains  # noqa: E501

        Lists policy domains the current user has access to.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.policy_domains_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['page', 'limit', 'filter_id', 'policy_ready', 'recommendation']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method policy_domains_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'policy_ready' in params:
            query_params.append(('policy_ready', params['policy_ready']))  # noqa: E501
        if 'recommendation' in params:
            query_params.append(('recommendation', params['recommendation']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesPolicyDomainList',  # noqa: E501
