...
class Data26(object):
    ...
    attribute_map = {
        'email': 'email',
        'is_admin': 'is_admin',
        'has_forensic_access': 'has_forensic_access',
        'has_billing_access': 'has_billing_access'
    }

    def __init__(self, email=None, is_admin=None, has_forensic_access=None, has_billing_access=None, _configuration=None):  # noqa: E501
        """Data26 - a model defined in Swagger"""  # noqa: E501
        ...
        self._email = None
        self._is_admin = None
        self._has_forensic_access = None
        self._has_billing_access = None
        ...
        if has_forensic_access is not None:
            self.has_forensic_access = has_forensic_access
        if has_billing_access is not None:
            self.has_billing_access = has_billing_access

    @property
    def email(self):
        """Gets the email of this Data26.  # noqa: E501

          # noqa: E501

        :return: The email of this Data26.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this Data26.

          # noqa: E501

        :param email: The email of this Data26.  # noqa: E501
        :type: str
        """
    ...
    @property
    def is_admin(self):
        """Gets the is_admin of this Data26.  # noqa: E501

        Admin access allows users to create domain groups and manage both user and domain group access control.  # noqa: E501

        :return: The is_admin of this Data26.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_admin(self, is_admin):
        """Sets the is_admin of this Data26.

        Admin access allows users to create domain groups and manage both user and domain group access control.  # noqa: E501

        :param is_admin: The is_admin of this Data26.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def has_forensic_access(self):
        """Gets the has_forensic_access of this Data26.  # noqa: E501

        Granting Forensic access gives users access to view DMARC Forensic reports.  # noqa: E501

        :return: The has_forensic_access of this Data26.  # noqa: E501
        :rtype: bool
        """
        return self._has_forensic_access

    @has_forensic_access.setter
    def has_forensic_access(self, has_forensic_access):
        """Sets the has_forensic_access of this Data26.

        Granting Forensic access gives users access to view DMARC Forensic reports.  # noqa: E501

        :param has_forensic_access: The has_forensic_access of this Data26.  # noqa: E501
        :type: bool
        """

        self._has_forensic_access = has_forensic_access

    @property
    def has_billing_access(self):
        """Gets the has_billing_access of this Data26.  # noqa: E501

        Giving users billing access will let them view and manage subscription and payment information.  # noqa: E501

        :return: The has_billing_access of this Data26.  # noqa: E501
        :rtype: bool
        """
        return self._has_billing_access

    @has_billing_access.setter
    def has_billing_access(self, has_billing_access):
        """Sets the has_billing_access of this Data26.

        Giving users billing access will let them view and manage subscription and payment information.  # noqa: E501

        :param has_billing_access: The has_billing_access of this Data26.  # noqa: E501
        :type: bool
        """

        self._has_billing_access = has_billing_access
