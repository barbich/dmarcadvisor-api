...
import dmarcadvisor
from dmarcadvisor.api.domain_group_access_control_list__acl_api import DomainGroupAccessControlListACLApi  # noqa: E501
from dmarcadvisor.rest import ApiException


class TestDomainGroupAccessControlListACLApi(unittest.TestCase):
    """DomainGroupAccessControlListACLApi unit test stubs"""

    def setUp(self):
        self.api = dmarcadvisor.api.domain_group_access_control_list__acl_api.DomainGroupAccessControlListACLApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_domain_groups_acl_add_admin_users(self):
        """Test case for domain_groups_acl_add_admin_users

        Add write level access for an user of a domain group  # noqa: E501
        """
        pass

    def test_domain_groups_acl_add_readonly_users(self):
        """Test case for domain_groups_acl_add_readonly_users

        Add read-only level access for an user of a domain group  # noqa: E501
        """
        pass

    def test_domain_groups_acl_list(self):
        """Test case for domain_groups_acl_list

        Get a list of all domain groups and user access levels  # noqa: E501
        """
        pass

    def test_domain_groups_acl_set_no_access(self):
        """Test case for domain_groups_acl_set_no_access
