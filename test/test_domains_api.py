...
import dmarcadvisor
from dmarcadvisor.api.domains_api import DomainsApi  # noqa: E501
...
class TestDomainsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = dmarcadvisor.api.domains_api.DomainsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_domains_delete0(self):
        """Test case for domains_delete0
    ...
    def test_domains_refresh(self):
        """Test case for domains_refresh
