...
class ForensicReportsApi(object):
    ...
    def forensics_list(self, **kwargs):  # noqa: E501
        """List forensic reports  # noqa: E501

        Lists forensic reports belonging to the current account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensics_list(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cursor: The pagination cursor value.
        :param int limit: Number of results to return per page.
        :param float filter_id: Forensic filter id to filter reports by.
        :return: ResponsesForensicReportList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forensics_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.forensics_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def forensics_list_with_http_info(self, **kwargs):  # noqa: E501
        """List forensic reports  # noqa: E501

        Lists forensic reports belonging to the current account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensics_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cursor', 'limit', 'filter_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesForensicReportList',  # noqa: E501
