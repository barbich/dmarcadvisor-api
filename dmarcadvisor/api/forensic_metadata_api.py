...
class ForensicMetadataApi(object):
    ...
    def forensic_metadata_read(self, **kwargs):  # noqa: E501
        """Get forensic metadata  # noqa: E501

        Retrieves forensic metadata.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_metadata_read(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: ResponsesForensicMetadata
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forensic_metadata_read_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.forensic_metadata_read_with_http_info(**kwargs)  # noqa: E501
            return data

    def forensic_metadata_read_with_http_info(self, **kwargs):  # noqa: E501
        """Get forensic metadata  # noqa: E501

        Retrieves forensic metadata.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_metadata_read_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method forensic_metadata_read" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesForensicMetadata',  # noqa: E501
