...
class DefaultApi(object):
    ...
    def domains_delete_create(self, **kwargs):  # noqa: E501
        """Delete domains in bulk  # noqa: E501

        Deletes the posted domain list and all related data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_delete_create(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.domains_delete_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.domains_delete_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def domains_delete_create_with_http_info(self, **kwargs):  # noqa: E501
        """Delete domains in bulk  # noqa: E501

        Deletes the posted domain list and all related data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_delete_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method domains_delete_create" % key
                )
            params[key] = val
        del params['kwargs']
