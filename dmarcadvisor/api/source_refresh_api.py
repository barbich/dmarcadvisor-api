...
class SourceRefreshApi(object):
    ...
    def sources_refresh_create(self, **kwargs):  # noqa: E501
        """Create source refresh  # noqa: E501

        Creates (triggers) source data refreshing.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_refresh_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: ResponsesSourceRefresh
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sources_refresh_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.sources_refresh_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def sources_refresh_create_with_http_info(self, **kwargs):  # noqa: E501
        """Create source refresh  # noqa: E501

        Creates (triggers) source data refreshing.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_refresh_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method sources_refresh_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesSourceRefresh',  # noqa: E501
    ...
    def sources_refresh_read(self, **kwargs):  # noqa: E501
        """Get source refresh  # noqa: E501

        Retrieves source refresh details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_refresh_read(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sources_refresh_read_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.sources_refresh_read_with_http_info(**kwargs)  # noqa: E501
            return data

    def sources_refresh_read_with_http_info(self, **kwargs):  # noqa: E501
        """Get source refresh  # noqa: E501

        Retrieves source refresh details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_refresh_read_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sources_refresh_read" % key
                )
            params[key] = val
        del params['kwargs']
