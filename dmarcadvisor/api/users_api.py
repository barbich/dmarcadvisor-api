...
class UsersApi(object):
    ...
    def users_activation_reminder(self, id, **kwargs):  # noqa: E501
        """Send an email activation reminder  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_activation_reminder(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.users_activation_reminder_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.users_activation_reminder_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def users_activation_reminder_with_http_info(self, id, **kwargs):  # noqa: E501
        """Send an email activation reminder  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_activation_reminder_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method users_activation_reminder" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `users_activation_reminder`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/users/{id}/activation-reminder/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def users_convert_to_sso(self, id, **kwargs):  # noqa: E501
        """Convert an user to SSO login  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_convert_to_sso(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_convert_to_sso_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.users_convert_to_sso_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def users_convert_to_sso_with_http_info(self, id, **kwargs):  # noqa: E501
        """Convert an user to SSO login  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_convert_to_sso_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method users_convert_to_sso" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `users_convert_to_sso`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/users/{id}/convert-to-sso/', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesUser',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def users_create(self, **kwargs):  # noqa: E501
        """Create and add a new user to an account  # noqa: E501

        An email with an activation list is send upon each user creation. Note, the user must click through the link in order to activate the account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.users_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def users_create_with_http_info(self, **kwargs):  # noqa: E501
        """Create and add a new user to an account  # noqa: E501

        An email with an activation list is send upon each user creation. Note, the user must click through the link in order to activate the account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_create_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def users_delete(self, id, **kwargs):  # noqa: E501
        ...
        Note, account owner could not be deleted.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def users_list(self, **kwargs):  # noqa: E501
        """Get a list of all users within an account  # noqa: E501
        ...
        :param str username: Filter users by username.
        :param str email: Filter users by email address.
        :param str ordering: Default: \"\".   Valid values: \"username\", \"-username\",\"email\", \"-email\"    (prefix with \"-\" for descending sort).
        :return: ResponsesUserList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def users_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'limit', 'username', 'email', 'ordering']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesUserList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def users_partial_update(self, id, **kwargs):  # noqa: E501
        """Partial update of user details  # noqa: E501
    ...
    def users_password_change(self, id, **kwargs):  # noqa: E501
        """Change user password  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_password_change(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_password_change_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.users_password_change_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def users_password_change_with_http_info(self, id, **kwargs):  # noqa: E501
        """Change user password  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_password_change_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method users_password_change" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `users_password_change`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/users/{id}/password-change/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def users_password_reset(self, id, **kwargs):  # noqa: E501
        """Send password reset email  # noqa: E501

        Sends an email to the user that can trigger a password reset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_password_reset(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_password_reset_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.users_password_reset_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def users_password_reset_with_http_info(self, id, **kwargs):  # noqa: E501
        """Send password reset email  # noqa: E501

        Sends an email to the user that can trigger a password reset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_password_reset_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method users_password_reset" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `users_password_reset`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/users/{id}/password-reset/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def users_update(self, id, **kwargs):  # noqa: E501
        """Update user details  # noqa: E501

        Every email change request  triggers an email confirmation. Note, there is a separate endpoint for password changes, see \"Change user password\".  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_update(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_update_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.users_update_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def users_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update user details  # noqa: E501

        Every email change request  triggers an email confirmation. Note, there is a separate endpoint for password changes, see \"Change user password\".  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
