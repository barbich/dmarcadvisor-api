...
class IssuesApi(object):
    ...
    def issues_list(self, **kwargs):  # noqa: E501
        """List issues  # noqa: E501

        Lists all domain issues discovered for the account.  # noqa: E501
        ...
        :param float group_id: Filter results by domains belonging to the group id.
        :param str top_level: Show issues for domains treated as top level (True) or for subdomains (False).
        :param str solved: Show solved issues (True) or not (False).
        :param str ignored: Show ignored issues (True) or not (False).
        :param str domain_state: Filter results by domain state (\"active\", \"inactive\", \"unknown\").
        :param str assigned_to_group: Filter results by domains assigned to a group (different than the default one).
        :param str domain: Filter results by domain.
        :return: ResponsesIssueList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issues_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.issues_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def issues_list_with_http_info(self, **kwargs):  # noqa: E501
        """List issues  # noqa: E501

        Lists all domain issues discovered for the account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issues_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['page', 'limit', 'group_id', 'top_level', 'solved', 'ignored', 'domain_state', 'assigned_to_group', 'domain']  # noqa: E501
        ...
        if 'ignored' in params:
            query_params.append(('ignored', params['ignored']))  # noqa: E501
        if 'domain_state' in params:
            query_params.append(('domain_state', params['domain_state']))  # noqa: E501
        if 'assigned_to_group' in params:
            query_params.append(('assigned_to_group', params['assigned_to_group']))  # noqa: E501
        if 'domain' in params:
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesIssueList',  # noqa: E501
    ...
    def issues_partial_update(self, id, **kwargs):  # noqa: E501
        """Update issue (partial)  # noqa: E501

        Updates some of the issue properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issues_partial_update_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.issues_partial_update_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def issues_partial_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update issue (partial)  # noqa: E501

        Updates some of the issue properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issues_partial_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `issues_partial_update`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesIssue',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def issues_read(self, id, **kwargs):  # noqa: E501
        """Get issue  # noqa: E501

        Retrieves issue details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issues_read(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issues_read_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.issues_read_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def issues_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get issue  # noqa: E501

        Retrieves issue details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issues_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `issues_read`")  # noqa: E501
    ...
    def issues_update(self, id, **kwargs):  # noqa: E501
        """Update issue  # noqa: E501

        Updates issue properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issues_update(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issues_update_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.issues_update_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def issues_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update issue  # noqa: E501

        Updates issue properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issues_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `issues_update`")  # noqa: E501
