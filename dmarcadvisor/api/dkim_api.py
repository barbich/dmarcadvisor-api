...
class DKIMApi(object):
    ...
    def dkim_inspect_create(self, **kwargs):  # noqa: E501
        """Inspect DKIM record  # noqa: E501

        Inspects a published DKIM record for a specific domain and selector.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dkim_inspect_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Data data:
        :return: ResponsesDKIMInspection
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.dkim_inspect_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.dkim_inspect_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def dkim_inspect_create_with_http_info(self, **kwargs):  # noqa: E501
        """Inspect DKIM record  # noqa: E501

        Inspects a published DKIM record for a specific domain and selector.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dkim_inspect_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method dkim_inspect_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesDKIMInspection',  # noqa: E501
    ...
    def dkim_validate_create(self, **kwargs):  # noqa: E501
        """Validate DKIM record  # noqa: E501

        Validates a DKIM record string.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dkim_validate_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Data1 data:
        :return: ResponsesDKIMValidation
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.dkim_validate_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.dkim_validate_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def dkim_validate_create_with_http_info(self, **kwargs):  # noqa: E501
        """Validate DKIM record  # noqa: E501

        Validates a DKIM record string.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dkim_validate_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method dkim_validate_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesDKIMValidation',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
