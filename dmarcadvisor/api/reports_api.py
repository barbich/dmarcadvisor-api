...
class ReportsApi(object):
    ...
    def detail_viewer_create(self, **kwargs):  # noqa: E501
        """Create Detail Viewer report  # noqa: E501

        Report creation is asynchronous process. In case report already exists for the given input, response status code is 200. If report creation is started, then 202 is returned. While report is being prepared, only available call is to check its progress (available in \"_links\"). Progress endpoint must be called on certain time interval. When progress value become 100 %, report is ready and its data could be retrieved. Any calls to report data before it is ready will return 404 Not found.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detail_viewer_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Data2 data:
        :return: ResponsesQueryJob
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.detail_viewer_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.detail_viewer_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def detail_viewer_create_with_http_info(self, **kwargs):  # noqa: E501
        """Create Detail Viewer report  # noqa: E501

        Report creation is asynchronous process. In case report already exists for the given input, response status code is 200. If report creation is started, then 202 is returned. While report is being prepared, only available call is to check its progress (available in \"_links\"). Progress endpoint must be called on certain time interval. When progress value become 100 %, report is ready and its data could be retrieved. Any calls to report data before it is ready will return 404 Not found.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detail_viewer_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method detail_viewer_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesQueryJob',  # noqa: E501
    ...
    def detail_viewer_list(self, **kwargs):  # noqa: E501
        """List Detail Viewer reports  # noqa: E501

        List current user`s Detail Viewer reports. Each report availability is up to 3 days.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detail_viewer_list(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int page: A page number within the paginated result set.
        :param int limit: Number of results to return per page.
        :param str ordering: Default: \"-created\".   Valid values: \"created\", \"-created\"    (prefix with \"-\" for descending sort).
        :return: ResponsesQueryJobList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.detail_viewer_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.detail_viewer_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def detail_viewer_list_with_http_info(self, **kwargs):  # noqa: E501
        """List Detail Viewer reports  # noqa: E501

        List current user`s Detail Viewer reports. Each report availability is up to 3 days.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detail_viewer_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['page', 'limit', 'ordering']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method detail_viewer_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesQueryJobList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def detail_viewer_read(self, search_token, **kwargs):  # noqa: E501
        """List/create Detail Viewer reports.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detail_viewer_read(search_token, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.detail_viewer_read_with_http_info(search_token, **kwargs)  # noqa: E501
        else:
            (data) = self.detail_viewer_read_with_http_info(search_token, **kwargs)  # noqa: E501
            return data

    def detail_viewer_read_with_http_info(self, search_token, **kwargs):  # noqa: E501
        """List/create Detail Viewer reports.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detail_viewer_read_with_http_info(search_token, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method detail_viewer_read" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('search_token' not in params or
            ...
            raise ValueError("Missing the required parameter `search_token` when calling `detail_viewer_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/detail-viewer/{search_token}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
