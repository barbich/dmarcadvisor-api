...
class SourceFiltersApi(object):
    ...
    def source_filters_create(self, **kwargs):  # noqa: E501
        """Create source filter  # noqa: E501

        Creates a new source filter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_filters_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Data21 data:
        :return: ResponsesSourceFilter
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.source_filters_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.source_filters_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def source_filters_create_with_http_info(self, **kwargs):  # noqa: E501
        """Create source filter  # noqa: E501

        Creates a new source filter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_filters_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method source_filters_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesSourceFilter',  # noqa: E501
    ...
    def source_filters_list(self, **kwargs):  # noqa: E501
        """List source filters  # noqa: E501

        Lists stored source filters ordered by date descendingly.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_filters_list(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int page: A page number within the paginated result set.
        :param int limit: Number of results to return per page.
        :return: ResponsesSourceFilterList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.source_filters_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.source_filters_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def source_filters_list_with_http_info(self, **kwargs):  # noqa: E501
        """List source filters  # noqa: E501

        Lists stored source filters ordered by date descendingly.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_filters_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method source_filters_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesSourceFilterList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def source_filters_read(self, id, **kwargs):  # noqa: E501
        """Get source filter  # noqa: E501

        Retrieves source filter details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_filters_read(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.source_filters_read_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.source_filters_read_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def source_filters_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get source filter  # noqa: E501

        Retrieves source filter details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_filters_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method source_filters_read" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `source_filters_read`")  # noqa: E501
