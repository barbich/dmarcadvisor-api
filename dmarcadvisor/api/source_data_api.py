...
class SourceDataApi(object):
    ...
    def source_domains_list(self, **kwargs):  # noqa: E501
        """List source domains  # noqa: E501

        Lists current account's known domain volume by source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_domains_list(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int page: A page number within the paginated result set.
        :param int limit: Number of results to return per page.
        :param str source_number: Source number to return data for.
        :param float filter_id: Source filter id to filter data by.
        :return: ResponsesSourceDomainList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.source_domains_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.source_domains_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def source_domains_list_with_http_info(self, **kwargs):  # noqa: E501
        """List source domains  # noqa: E501

        Lists current account's known domain volume by source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_domains_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['page', 'limit', 'source_number', 'filter_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method source_domains_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesSourceDomainList',  # noqa: E501
    ...
    def sources_list(self, **kwargs):  # noqa: E501
        """List sources  # noqa: E501

        Lists current account's known sources with volume totals.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_list(async_req=True)
        >>> result = thread.get()
        ...
        :param int limit: Number of results to return per page.
        :param float filter_id: Source filter id to filter data by.
        :return: ResponsesSourceList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sources_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.sources_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def sources_list_with_http_info(self, **kwargs):  # noqa: E501
        """List sources  # noqa: E501

        Lists current account's known sources with volume totals.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['page', 'limit', 'filter_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesSourceList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
