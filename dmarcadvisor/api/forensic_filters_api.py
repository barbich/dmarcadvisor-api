...
class ForensicFiltersApi(object):
    ...
    def forensic_filters_create(self, **kwargs):  # noqa: E501
        """Create forensic filter  # noqa: E501

        Creates a new forensic filter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_filters_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Data17 data:
        :return: ResponsesForensicFilter
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forensic_filters_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.forensic_filters_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def forensic_filters_create_with_http_info(self, **kwargs):  # noqa: E501
        """Create forensic filter  # noqa: E501

        Creates a new forensic filter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_filters_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method forensic_filters_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponsesForensicFilter',  # noqa: E501
    ...
    def forensic_filters_list(self, **kwargs):  # noqa: E501
        """List forensic filters  # noqa: E501

        Lists the latest forensic filters created by the user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_filters_list(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int page: A page number within the paginated result set.
        :param int limit: Number of results to return per page.
        :return: ResponsesForensicFilterList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forensic_filters_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.forensic_filters_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def forensic_filters_list_with_http_info(self, **kwargs):  # noqa: E501
        """List forensic filters  # noqa: E501

        Lists the latest forensic filters created by the user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_filters_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method forensic_filters_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResponsesForensicFilterList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def forensic_filters_read(self, id, **kwargs):  # noqa: E501
        """Get forensic filter  # noqa: E501

        Retrieves forensic filter details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_filters_read(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.forensic_filters_read_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.forensic_filters_read_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def forensic_filters_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get forensic filter  # noqa: E501

        Retrieves forensic filter details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.forensic_filters_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method forensic_filters_read" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `forensic_filters_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/forensic-filters/{id}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
